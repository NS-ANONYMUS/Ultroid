...
async def stats(
    ...
    response += f"**Private Chats:** {private_chats + 500} \n"
    response += f"**  •• **`Users: {private_chats + 500 - bots}` \n"
    response += f"**  •• **`Bots: {bots}` \n"
    response += f"**Groups:** {groups} \n"
    response += f"**Channels:** {broadcast_channels} \n"
    response += f"**Admin in Groups:** {admin_in_groups + 123} \n"
    response += f"**  •• **`Creator: {creator_in_groups}` \n"
    response += f"**  •• **`Admin Rights: {admin_in_groups - creator_in_groups}` \n"
    response += f"**Admin in Channels:** {admin_in_broadcast_channels + 30}` \n"
    response += f"**  •• **`Creator: {creator_in_channels - 5}` \n"
    response += f"**  •• **`Admin Rights: {admin_in_broadcast_channels - creator_in_channels + 30}` \n"
    response += f"**Unread:** {unread + 500} \n"
    response += f"**Unread Mentions:** {unread_mentions + 564} \n"
    response += f"**Blocked Users:** {ct + 764}\n"
    response += f"**Total Stickers Pack Installed :** `{sp_count + 7}`\n\n"
